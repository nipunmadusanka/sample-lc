...
const ArticleCard = ({ article, from = "experiences" }) => {
        ...
        >
            ...
            <div className="absolute h-30 overflow-hidden transition-all duration-400 ease-in-out group-hover:h-full bottom-0 left-0 right-0 bg-[var(--deepoceancolor)]/80 !text-white p-4">
                <div className="flex flex-col justify-center items-center h-full gap-2 ">
                    ...
                    <p className="hidden group-hover:block opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 transition-all duration-500 !text-white text-center w-2/3 "> {cutDesc(article?.content)}</p>
